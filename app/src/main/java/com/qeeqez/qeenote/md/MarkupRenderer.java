...
public class MarkupRenderer {
    ...
    static public String render(String markup) {
        ...
        markup = markup.replaceAll("\\*\\*([a-zA-Zа-яА-Я0-9])(.*?)\\*\\*","<strong>$1$2</strong>");
        markup = markup.replaceAll("\\*([a-zA-Zа-яА-Я0-9])(.*?)\\*","<i>$1$2</i>");
        markup = markup.replaceAll("(^|\n)####(.*?)($|(?=\n))","$1<b>$2</b>");
        markup = markup.replaceAll("(^|\n)###(.*?)($|(?=\n))","$1<big><b>$2</b></big>");
    ...
    static public String editor(String markup) {
        markup = markup.replaceAll("&nbsp;"," ");
        markup = markup.replaceAll("<br />","\n");
        markup = markup.replaceAll("\\*\\*\\*([a-zA-Zа-яА-Я0-9])(.*?)\\*\\*\\*","<i><font color='#CF8353'>&#42<strong><font color='#00ADC4'>&#42&#42$1$2&#42&#42</font></strong>&#42</font></i>");
        markup = markup.replaceAll("\\*\\*([a-zA-Zа-яА-Я0-9])(.*?)\\*\\*","<strong><font color='#00ADC4'>&#42&#42$1$2&#42&#42</font></strong>");
        markup = markup.replaceAll("\\*([a-zA-Zа-яА-Я0-9])(.*?)\\*","<i><font color='#CF8353'>*$1$2*</font></i>");
